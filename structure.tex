...
%\setmainfont{Palatino} % Sets Palatino as main font, must be installed on the system compiling the document
...
%\setsansfont{Copperplate Gothic Bold} % Note: you may need to take out the \bfseries from the definition of \resumename as this font has bold as the regular variant of the font and doesn't have a bold variant. Do this only if you run into problems with using the font.
...
\newcommand{\resumename}[1]{{\centering\Huge\sffamily\bfseries\textsc{#1}\par}} % Style the resume name
